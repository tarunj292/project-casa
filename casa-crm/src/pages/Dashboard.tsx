...
const Dashboard = () => {
  ...
  const stats = [
    ...
    { title: 'Active Customers', value: '2,431', change: '+5%', icon: Users, color: 'bg-blue-500' },
    { title: 'Products Sold', value: '1,543', change: '+18%', icon: Package, color: 'bg-purple-500' },
    { title: 'Conversion Rate', value: '3.2%', change: '+2%', icon: TrendingUp, color: 'bg-orange-500' },
  ];

  const recentActivity = [
    { action: 'New order from Sarah Johnson', time: '5 min ago', status: 'success' },
    { action: 'Brand registration approved', time: '12 min ago', status: 'info' },
    { action: 'Low stock alert: Nike Shoes', time: '30 min ago', status: 'warning' },
    { action: 'Payment received $1,250', time: '1 hour ago', status: 'success' },
  ];
