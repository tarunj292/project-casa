...
const BrandPage: React.FC = () => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    let list = products.filter((p) => {
      ...
      const genderOk = g === "all" || pg === g || (g === "unisex" && pg === "unisex");
      const categoryOk =
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <header className="sticky top-0 z-50 bg-gray-950/95 backdrop-blur border-b border-gray-900">
        <div className="flex items-center justify-between p-4">
          <button
            ...
            aria-label="Go back"
            className="p-2 rounded-full hover:bg-gray-900 active:scale-95"
          >
            <ArrowLeft size={22} />
          </button>
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-full hover:bg-gray-900 disabled:opacity-50"
              disabled
            >
              <Search size={22} />
            </button>
      ...
      <section className="px-4 py-6 bg-gradient-to-b from-gray-900 to-transparent">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl font-bold uppercase tracking-wide truncate">{brand.name}</h1>
        ...
        {brand.description && (
          <p className="text-sm text-gray-300 leading-relaxed line-clamp-3">{brand.description}</p>
        )}
      </section>
      ...
      <section className="px-4">
        <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-thin">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm active:scale-95 transition ${
              showFilters ? "bg-blue-600 text-white" : "bg-gray-900 text-gray-200 border border-gray-800"
            }`}
        ...
        {showFilters && (
          <div id="desktop-filters" className="mt-3 bg-gray-900 border border-gray-800 rounded-xl p-3">
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <p className="mt-2 text-base font-bold">
                        {formatINRCurrency(priceNum, product.currency || "INR")}
                      </p>
                    </div>
                  </button>
                  ...
                  <div className="px-3 pb-3">
                    <button
                      ...
                      aria-live="polite"
                    >
                      {inCart ? "✓ Added to Bag" : addingToCart === product._id ? "Adding…" : "Add to Bag"}
                    </button>
                  </div>
                </article>
              );
